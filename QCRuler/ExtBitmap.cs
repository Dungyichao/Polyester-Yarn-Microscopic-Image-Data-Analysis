        ...
        public static Bitmap ConvolutionFilter(Bitmap sourceBitmap, double[,] filterMatrix, double factor, int bias, bool grayscale) 
{
    ...
    return resultBitmap;
        ...
        public static Bitmap Convolve(this Bitmap srcImage, double[,] kernel)
        {
        ...
        public static Bitmap ConvolutionFilter(this Bitmap sourceBitmap,double[,] xFilterMatrix,double[,] yFilterMatrix,double factor,int bias, int offset, bool grayscale)
        {
        ...
        grayscale = false;
            ...
            */
            ...
            /*
             * [System.Security.SecurityCritical]public static void 
            ...
            if (grayscale == true)
            {
                ...
                for (int k = 0; k < pixelBuffer.Length; k += 4)   // A pixel is made up of 4 components Alpha,Red,Green,Blue
                {
                    rgb = pixelBuffer[k] * 0.11f;
                    rgb += pixelBuffer[k + 1] * 0.59f;
                    rgb += pixelBuffer[k + 2] * 0.3f;
                    ...
                    pixelBuffer[k + 1] = pixelBuffer[k];
                    pixelBuffer[k + 2] = pixelBuffer[k];
                    pixelBuffer[k + 3] = 255; //Alpha determines the transparency
                }
            }
        ...
        public static Bitmap Laplacian3x3Filter(this Bitmap sourceBitmap,bool grayscale)
        {
            grayscale = true;
        ...
        public static Bitmap Laplacian5x5Filter(this Bitmap sourceBitmap,bool grayscale)
        {
            grayscale = true;
            Bitmap resultBitmap = ExtBitmap.ConvolutionFilter(sourceBitmap, 
        ...
        public static Bitmap Sobel3x3Filter(this Bitmap sourceBitmap, bool grayscale, int thred)
        {
            //grayscale = true;
            Bitmap resultBitmap = ExtBitmap.ConvolutionFilter(sourceBitmap, 
                                                 Matrix.Sobel3x3Horizontal, 
                                                   Matrix.Sobel3x3Vertical, 
                                                        1.0, 0, thred, grayscale);

            return resultBitmap;
        }
        public static Bitmap PrewittFilter(this Bitmap sourceBitmap, bool grayscale)  
        {
            //grayscale = true;
            Bitmap resultBitmap = ExtBitmap.ConvolutionFilter(sourceBitmap, Matrix.Prewitt3x3Horizontal, Matrix.Prewitt3x3Vertical, 1.0, 0, 30, grayscale);

            return resultBitmap;
        }
        public static Bitmap KirschFilter(this Bitmap sourceBitmap,bool grayscale)
        {
            //grayscale = true;
            Bitmap resultBitmap = ExtBitmap.ConvolutionFilter(sourceBitmap, 
