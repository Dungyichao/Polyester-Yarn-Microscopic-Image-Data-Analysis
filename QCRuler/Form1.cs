    ...
    //public static class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)   // Load Image
        {
            ...
            if (res == DialogResult.OK)
            {
                ...
                //bitmapResult1 = bitmapResult.Sobel3x3Filter(true, thred);  //Laplacian5x5Filter(true), Sobel3x3Filter(true), PrewittFilter(true), 
                //if (thred > 255)
                //{
                //    thred = 255;
                ...
                //
                //bitmapResult1 = bitmapResult.PrewittFilter(true);
                //bitmapResult2 = bitmapResult1.Sobel3x3Filter(true); 
